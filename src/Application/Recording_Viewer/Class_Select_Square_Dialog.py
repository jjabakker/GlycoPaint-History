...
class SelectSquareDialog:
    ...
    def __init__(self, image_viewer, callback, min_required_density_ratio, max_allowable_variability,
                 min_track_duration, max_track_duration, min_r_squared, neighbour_mode):
        """
    ...
    def setup_frame_filter(self):
        ...
        self.frame_min_r_squared = ttk.Frame(self.frame_filter, borderwidth=1, relief='groove',
                                             padding=(5, 5, 5, 5))
        ...
        self.setup_frame_min_r_squared()
        ...
        self.frame_min_r_squared.grid(column=4, row=0, padx=5, pady=5, sticky=(tk.N, tk.S, tk.E, tk.W))
    ...
    def setup_frame_min_r_squared(self):
        """
        Create a scale for a min r squared slider.

        """
        self.min_r_squared = tk.DoubleVar(value=0.9)  # Default value
        self.lbl_min_r_squared_text = ttk.Label(self.frame_min_r_squared, text='Min\nR Squared', width=10)
        self.sc_min_r_squared = tk.Scale(
            self.frame_min_r_squared, from_=0, to=1.0, variable=self.min_r_squared,
            orient='vertical', resolution=0.01)
        self.sc_min_r_squared.bind("<ButtonRelease-1>", lambda event: self.on_filter_changed('Min R Squared'))

        self.lbl_min_r_squared_text.grid(column=0, row=0, padx=5, pady=5)
        self.sc_min_r_squared.grid(column=0, row=1, padx=5, pady=5)
    ...
    def initialise_controls(
        ...
        self.min_r_squared.set(min_r_squared)
