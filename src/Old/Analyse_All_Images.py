...
from src.Application.Utilities.General_Support_Functions import ask_user_for_paint_directory
from src.Application.Utilities.General_Support_Functions import get_df_from_file
from src.Application.Utilities.General_Support_Functions import read_experiment_file
...
def analyse_all_images(paint_directory):
    ...
    for index, row in df_batch.iterrows():
        image_name = row['Ext Recording Name']
